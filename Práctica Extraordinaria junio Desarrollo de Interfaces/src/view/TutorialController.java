...
public class TutorialController {
    ...
    private void initialize() {
    	tutorialDatos.setText("En la pantalla de Datos se encuentra la tabla con los nombres y apellidos de los trabajadores los cuales podemos seleccionar con un click para ver el resto de información");
